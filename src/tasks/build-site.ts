...
const assets=['index.html','style.css','liero.ttf','engine/openliero.mjs','engine/openliero.data','maps/temple.lev','maps/catalog.json','manifest.webmanifest','sw.js','favicon.ico','icon-180.png','icon-192.png','icon-512.png'];
