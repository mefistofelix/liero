...
export type Preferences={name:string;color:string;player2:{name:string;color:string};savedLoadouts:SavedLoadout[][];selectedLoadouts:string[];roomName:string;privateRoom:boolean;sound:boolean;showHud:boolean;keyboardOnly:boolean;loadouts:number[][];rules:Rules;rotation:string[];controls:Controls};
export const defaults:Preferences={name:'Player',color:'#6868fc',player2:{name:'Player 2',color:'#3cac3c'},savedLoadouts:[[{id:'default',name:'Default',weapons:[19,25,9,36,35]}],[{id:'default',name:'Default',weapons:[19,25,9,36,35]}]],selectedLoadouts:['default','default'],roomName:'My room',privateRoom:false,sound:true,showHud:false,keyboardOnly:true,loadouts:[[19,25,9,36,35],[19,25,9,36,35]],rules:{mode:0,lives:15,loading:20,bonuses:4},rotation:['temple'],controls:defaultControls};
